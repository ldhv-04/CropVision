...
const OWNER_PRIVATE_ALLOWLIST = new Set([
  ...
  'app/(station)/station/fields.js -> ../../../src/modules/station/pages/FieldsPage',
  'app/(station)/station/index.js -> ../../../src/modules/station/pages/DashboardPage',
  'app/(station)/station/interventions.js -> ../../../src/modules/station/pages/InterventionsPage',
  'app/(station)/station/microbiome.js -> ../../../src/modules/station/pages/MicrobiomePage',
  'app/(station)/station/recommendations.js -> ../../../src/modules/station/pages/RecommendationsPage',
  'app/(station)/station/reports.js -> ../../../src/modules/station/pages/ReportsPage',
  'app/(station)/station/sensors.js -> ../../../src/modules/station/pages/SensorsPage',
...
const ROUTE_MODULE_ALLOWLIST = new Set([
  ...
  'app/(agrivision)/index.js -> ../../src/modules/@core/api/apiClient',
  'app/(agrivision)/index.js -> ../../src/modules/@core/api/endpoints',
  ...
  'app/(station)/station/alerts.js -> ../../../src/modules/admin/components/AlertsAdminScreen',
]);
