...
const MAP_LAYERS = [
  { id: 'scans', label: 'Lịch sử quét', icon: '📸' },
  { id: 'outbreaks', label: 'Vùng dịch bệnh', icon: '🦠' },
  { id: 'simulations', label: 'Mô phỏng lây lan', icon: '🌊' },
];
    ...
    <div style={menuWidgetStyle}>
      <div style={scrollContainerStyle}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, marginTop: 8 }}>
          <div style={sectionLabelStyle}>Lớp bản đồ</div>
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                  <span style={{ fontSize: 15, width: 18, textAlign: 'center' }}>{layer.icon}</span>
