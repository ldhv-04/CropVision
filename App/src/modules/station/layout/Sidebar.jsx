...
const NAV_ITEMS = [
  { key: 'dashboard', label: 'Dashboard', icon: '📊', desc: 'Overview & KPIs' },
  { key: 'fields', label: 'Field Management', icon: '🗺️', desc: 'Maps & Zones' },
  { key: 'sensors', label: 'IoT Sensors', icon: '📡', desc: 'Real-time metrics' },
  { key: 'microbiome', label: 'Microbiome Analytics', icon: '🔬', desc: 'Soil health' },
  { key: 'recommendations', label: 'Recommendations', icon: '💡', desc: 'AI insights' },
  { key: 'interventions', label: 'Interventions', icon: '🔧', desc: 'Action log' },
  { key: 'reports', label: 'Reports', icon: '📄', desc: 'Export & analysis' },
];
  ...
  return (
    <aside style={sidebarStyle} data-testid="soilzepro-sidebar">
      ...
      <div style={scrollAreaStyle}>
        ...
        {NAV_ITEMS.slice(0, 4).map(renderItem)}

        <div style={sectionLabelStyle}>Intelligence</div>
        {NAV_ITEMS.slice(4).map(renderItem)}
      </div>
