    ...
    return (
      <View style={styles.center}>
        ...
        <TouchableOpacity
          ...
          onPress={() => fetchSummary(fieldId, zoneId)}
        >
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {conflict ? (
          <View style={styles.conflictCard}>
            <Text style={styles.conflictTitle}>Map changed</Text>
            ...
            <TouchableOpacity style={styles.secondaryButton} onPress={() => fetchSummary(fieldId, zoneId)}>
